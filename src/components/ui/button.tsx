...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap transition-colors leading-[19.2px] font-medium focus-visible:outline-none focus-visible:shadow-[0_0_7px_0_#FFF] disabled:pointer-events-none disabled:bg-neutral-100 disabled:text-disabled',
  {
    variants: {
      variant: {
