...
export const PartnershipSection = () => {
  ...
  return (
    <section className="2xl:container mx-auto">
      <div className="bg-[url(/images/partnership-illustration-home.svg)] min-h-[560px] bg-[length:800px] bg-center-bottom bg-no-repeat bg-primary-main md:bg-bottom md:bg-contain">
